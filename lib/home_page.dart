...
import 'package:project_f/feature_box.dart';
import 'package:project_f/openai_service.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<bool> _onWillPop() async {
    // Stop any ongoing actions like speech and TTS
    await stopListening();
    await flutterTts.stop();

    // Navigate back to the previous page or exit
    return true; // Returning true allows the back navigation
  }
